// Petit hasard deterministe. Une graine identique produit toujours le meme
// puzzle, dans le navigateur comme dans les tests Node.
...
export class Alea {
    ...
    entier(maximum) {
        return Math.floor(this.suivant() * maximum);
    }
